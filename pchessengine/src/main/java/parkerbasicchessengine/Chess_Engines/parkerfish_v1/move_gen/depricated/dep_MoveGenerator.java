package parkerbasicchessengine.Chess_Engines.parkerfish_v1.move_gen.depricated;
...
import parkerbasicchessengine.Chess_Engines.parkerfish_v1.move_gen.MoveList;
import parkerbasicchessengine.Chess_Engines.parkerfish_v1.move_gen.SlidingMovementGeneration;

public class dep_MoveGenerator extends Constants {
    ...
    public dep_MoveGenerator(BitwiseBoard bwB) {
        this.bwB = bwB;
    }
    ...
    private void kingMoveGen(MoveList moveList) {
        ...
        generateSlidingMoves(dep_MoveGenerator.kingMoves[kingIndex] & ~teamMask[team], kingIndex, BitwiseMove.NORMAL_MOVE, moveList);
    ...
    private void knightMoveGen(MoveList moveList) {
        ...
        while (knightLooper.hasNext) {
            ...
            long knightMoves = dep_MoveGenerator.knightMoves[knightIndex];
