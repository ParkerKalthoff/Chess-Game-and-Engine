...
public class MoveGenerator extends Constants {
    ...
    private void kingMoveGen(MoveList moveList){
        ...
        long normalMovesBitboard = this.kingMoves[kingIndex];
    ...
    private void slidingPieceMoveGen(MoveList moveList){
        ...
        while(pieceLoop.hasNext){
            ...
            long bishopMovementBitboard = SlidingMovementGeneration.generateBishopMovementBitboard(currentPiece, this.allPieces);
        ...
        while(pieceLoop.hasNext){
            currentPiece = Long.numberOfTrailingZeros(pieceLoop.getNext());
            long rookMovementBitboard = SlidingMovementGeneration.generateBishopMovementBitboard(currentPiece, this.allPieces);
        ...
        while(pieceLoop.hasNext){
            currentPiece = Long.numberOfTrailingZeros(pieceLoop.getNext());
            long queenMovementBitboard = SlidingMovementGeneration.generateBishopMovementBitboard(currentPiece, this.allPieces);
